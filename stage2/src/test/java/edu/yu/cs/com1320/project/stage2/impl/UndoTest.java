...
public class UndoTest {
    ...
    @Test
    public void undoNonexistentURI() throws Exception {
        DocumentStoreImpl dsi = createStoreAndPutAll();
        URI uri5 = new URI("http://edu.yu.cs/com1320/project/doc4");
        assertThrows(IllegalStateException.class,()->{dsi.undo(uri5);},"undo should throw an exception when there's nothing to undo");
    }
}